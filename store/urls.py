...
urlpatterns = [
    ...
    path('product/<int:product_id>/<slug:slug>/', views.product_detail, name='product_detail_slug'),
    path('care-guides/', views.care_guides, name='care_guides'),
    path('about-us/', views.about_us, name='about_us'),
    path('contact/', views.contact, name='contact'),
    path('car_guides/', views.care_guides, name='care_guides'),
    ...
    path('orders/<int:order_id>/update/', staff_member_required(views.update_order_status), name='update_order_status'),
]